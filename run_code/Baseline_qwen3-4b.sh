#!/usr/bin/env bash
# ============================================================================
# Baseline GRPO - Qwen3-4B on Math
# ============================================================================
# Standard GRPO training without any pretrain loss or sample filtering.
# All samples (positive + negative) contribute to RL loss as usual.
# ============================================================================
...
# ========================== Experiment Name ==========================
experiment_name="Baseline_GRPO_Qwen3-4B_math_bsz128_n${n_resp_per_prompt}_resp8k_clip${clip_ratio_high}_lr1e-6_$(date +%Y%m%d_%H%M%S)"
