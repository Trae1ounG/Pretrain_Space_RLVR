...
class AlgoConfig(BaseConfig):
    ...
    pretrain_norm_adv_by_std: bool = None  # If None, uses norm_adv_by_std_in_grpo; otherwise uses this for pretrain advantage
    ...
    pretrain_loss_coef: float = 0.01
    pretrain_only: bool = False
    pretrain_max_response_length: Optional[int] = None  # If set, truncate pretrain data to this length; otherwise use max_response_length
    pretrain_loss_disable_step: Optional[int] = None  # If set, disable pretrain loss after this step (pretrain_loss_coef becomes 0)
    pretrain_only_warmup: bool = False  # If True, only pretrain loss is computed before pretrain_loss_disable_step
